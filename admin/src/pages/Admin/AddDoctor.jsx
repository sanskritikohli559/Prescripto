...
const AddDoctor = () => {
  ...
  const [docImg,setDoctImg] = useState(false)
    ...
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex items-center gap-4 mb-8 text-gray-500'>
          ...
          <input onChange={(e)=> setDoctImg(e.target.files[0])} type="file" id="doc-img" hidden />
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          ...
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            ...
            <div className='flex flex-col gap-1'>
              <p>Address</p>
              <input onChange={(e)=> setAddress1(e.target.value)} value={address1} className='border rounded px-3 py-2 mb-2' type="text" placeholder='Address Line 1' required />
        ...
        <div className='mt-6 flex flex-col gap-1 text-gray-600'>
          <p>About Doctor</p>
          <textarea onChange={(e)=> setAbout(e.target.value)} value={about} className='border rounded px-4 py-2' placeholder='Write about doctor' rows={5} required />
        </div>

        <button className='bg-primary px-10 py-3 mt-6 text-white rounded-full hover:opacity-90' type='submit'>
          Add Doctor
        </button>
